...
import alittlemoretosea.mod.entity.rod.nullhook.EntityNullHook;
...
public class ItemNullRod extends ItemFishingRod implements IHasModel
{
    public ItemNullRod(String name)
    {
        ...
        this.setCreativeTab(Main.ALITTLEMORETOSEATAB);
        this.addPropertyOverride(new ResourceLocation("cast"), new IItemPropertyGetter()
        {
            ...
            public float apply(ItemStack stack, @Nullable World worldIn, @Nullable EntityLivingBase entityIn)
            {
                ...
                else
                {
                    ...
                    if (entityIn.getHeldItemMainhand().getItem() instanceof ItemNullRod)
                    {
                        flag1 = false;
                    }
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        else
        {
            ...
            if (!worldIn.isRemote)
            {
                EntityNullHook entityfishhook = new EntityNullHook(worldIn, playerIn);
